...
uploadGambar=()=>{
    ...
    const url="https://latihanuas.000webhostapp.com/api/upload.php"
    fetch(url, {
        method:'post',
        body:data
    })
        ...
        return (
            ...
            <View style={styles.container}>
            {
                ...
                <View style={styles.header}>
                    <Text style={styles.textHeader}>Upload Barang</Text>
                </View>
                ...
                <View style={styles.vButton}>
                    <View style={styles.button}>
                        <Button onPress={this.pilihGambar} color="green" title="Pilih Gambar"/>
                    </View>

                    <View style={styles.button2}>
                        <Button onPress={this.uploadGambar} color="green" title="Upload Gambar" />
                    </View>
